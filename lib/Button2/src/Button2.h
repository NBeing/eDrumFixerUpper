...
class Button2 {
 protected:
  ...
  typedef std::function<uint8_t(void* ctx)> StateCallbackFunctionEx;

#else
  typedef void (*CallbackFunction)(Button2 &);

  typedef uint8_t (*StateCallbackFunction)();
  typedef uint8_t (*StateCallbackFunctionEx)(void* ctx);
  ...
  void _reportClicks();
  void _setID();
  // void setButtonStateFunction(StateCallbackFunctionEx f, void* ctx) {
 ...
 public:
  ...
  StateCallbackFunctionEx get_state_cb_ex = nullptr;
  void* get_state_ctx = nullptr;
 ...
 private:
  ...
  Hardware* hw;
  StateCallbackFunctionEx _customStateFunctionEx = nullptr;
  void* _customStateFunctionCtx = nullptr;
